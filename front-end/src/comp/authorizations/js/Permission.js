...
function Permission() {
  ...
  const handleGetData = (e) => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/permission-full-data/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/permission/${e.target.id.dataset.id}/`,
        {
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "Permission Already Added!", "error");
        } else {
  ...
  const handleAdd = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_HOSTNAME}/api/permission/`,
        {
          permission: e.target.permission.value,
          language: e.target.language.value,
          description: e.target.description.value,
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/permission/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
    ...
    <>
      ...
      <div className="bg-sec min-vh-100 py-5 ">
        <div className="container-fluid px-4">
          <h2 className="main-title">Permission</h2>
