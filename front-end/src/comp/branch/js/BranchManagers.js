...
function BranchManagers() {
  ...
  const handleGetData = (e) => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/branch-managers-full-data/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/branch-managers/${e.target.id.dataset.id}/`,
        {
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "Branch Manager Already Added!", "error");
        } else {
  ...
  const handleAdd = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_HOSTNAME}/api/branch-managers/`,
        {
          branch: e.target.branch.value,
          manager: e.target.manager.value,
        },
  ...
  const columns = [
    ...
    {
      name: "Manager",
      selector: (row) => row.manager.email,
      sortable: true,
      grow: 1,
    },
    {
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/branch-managers/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
    ...
    <>
      ...
      <div className="bg-sec min-vh-100 py-5 ">
        <div className="container-fluid px-4">
          <h2 className="main-title">Branch Manager</h2>
                  ...
                  <div className="modal-body">
                    <form onSubmit={handleAdd}>
                      ...
                      <div className="mb-3">
                        ...
                        <select id="manager" className="form-control">
                          {user &&
                            user.map((user) => (
                              <option key={user.id} value={user.id}>
                                {user.email}
