...
function BranchServicePrice() {
  ...
  const handleGetData = (e) => {
    axios
      .get(
        `${process.env.REACT_APP_HOSTNAME}/api/branch-service-price-full-data/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/branch-service-price/${e.target.id.dataset.id}/`,
        {
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "Branch Service Price Already Added!", "error");
        } else {
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/branch-service-price/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
                    ...
                    <form onSubmit={handleEdit}>
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          id="servicePrice"
                          className="form-control"
                          defaultValue={row.service_price}
                        />
                      </div>
    ...
    <>
      ...
      <div className="bg-sec min-vh-100 py-5 ">
        <div className="container-fluid px-4">
          <h2 className="main-title">Branch Service Price</h2>
...
export default BranchServicePrice;
