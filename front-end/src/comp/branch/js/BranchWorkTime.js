...
function BranchWorkTime() {
  ...
  const handleGetData = (e) => {
    axios
      .get(
        `${process.env.REACT_APP_HOSTNAME}/api/branch-work-time-full-data/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/branch-work-time/${e.target.id.dataset.id}/`,
        {
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "Branch Work Time Already Added!", "error");
        } else {
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/branch-work-time/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <form onSubmit={handleEdit}>
                      ...
                      <div className="mb-3">
                        <label htmlFor="openAt" className="col-form-label">
                          Open At
                        </label>
                        <input
                          type="time"
                          id="openAt"
                          className="form-control"
                          defaultValue={row.open_at}
                        />
                      </div>
                      <div className="mb-3">
                        <label htmlFor="closeAt" className="col-form-label">
                          Close At
                        </label>
                        <input
                          type="time"
    ...
    <>
      ...
      <div className="bg-sec min-vh-100 py-5 ">
        <div className="container-fluid px-4">
          <h2 className="main-title">Branch Work Time</h2>
