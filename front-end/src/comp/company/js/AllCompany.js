...
function AllCompany() {
  ...
  const getCompanyTypeData = () => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/company-type/`, {
        headers: {
  ...
  const handleGetData = (e) => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/company-full-data/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/company/${e.target.id.dataset.id}/`,
        {
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "Company Already Added!", "error");
        } else {
  ...
  const columns = [
    ...
    {
      name: "Company Type",
      selector: (row) => row.companytype.type,
      sortable: true,
      grow: 1,
    },
    {
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/company/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
                    ...
                    <form onSubmit={handleEdit}>
                      ...
                      <div className="mb-3">
                        ...
                        <select
                          id="type"
                          className="form-control"
                          defaultValue={row.companytype.id}
                        >
                          {type &&
                            type.map((type) => (
    ...
    <>
      ...
      <div className="bg-sec min-vh-100 py-5 ">
        <div className="container-fluid px-4">
          <h2 className="main-title">All Company</h2>
