...
function CompanyLocation() {
  ...
  const getLocationData = () => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/location/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const handleGetData = (e) => {
    axios
      .get(
        `${process.env.REACT_APP_HOSTNAME}/api/company-location-full-data/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/company-location/${e.target.id.dataset.id}/`,
        {
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "Company Location Already Added!", "error");
        } else {
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/company-location/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
    ...
    <>
      ...
      <div className="bg-sec min-vh-100 py-5 ">
        <div className="container-fluid px-4">
          <h2 className="main-title">Company Location</h2>
