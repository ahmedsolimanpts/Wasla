...
function CompanyManagers() {
  ...
  const handleGetData = (e) => {
    axios
      .get(
        `${process.env.REACT_APP_HOSTNAME}/api/company-managers-full-data/`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/company-managers/${e.target.id.dataset.id}/`,
        {
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "Company Manager Already Added!", "error");
        } else {
  ...
  const handleAdd = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_HOSTNAME}/api/company-managers/`,
        {
          company: e.target.company.value,
          manager: e.target.manager.value,
        },
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/company-managers/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
    ...
    <>
      ...
      <div className="bg-sec min-vh-100 py-5 ">
        <div className="container-fluid px-4">
          <h2 className="main-title">Company Manager</h2>
