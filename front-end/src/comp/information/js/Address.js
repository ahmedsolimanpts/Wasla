...
function Address() {
  ...
  const getDistrictData = () => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/city-district/`, {
        headers: {
  ...
  const handleGetData = (e) => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/address-full-data/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/address/${e.target.id.dataset.id}/`,
        {
          district: e.target.district.value,
          building_number: e.target.buildingNumber.value,
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "Address Already Added!", "error");
        } else {
  ...
  const handleAdd = (e) => {
    ...
    axios
      ...
      .then(() => {
        ...
        e.target.buildingNumber.value = "";
        e.target.street.value = "";
        e.target.description.value = "";
      })
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "District Already Added!", "error");
        } else {
          swal("Error!", "Something went wrong!", "error");
        }
      });
  ...
  const columns = [
    ...
    {
      name: "Building",
      selector: (row) => row.building_number,
      sortable: true,
      grow: 1,
    },
    {
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/address/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
                    ...
                    <form onSubmit={handleEdit}>
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          id="buildingNumber"
                          className="form-control"
                          defaultValue={row.building_number}
                        />
                      </div>
                      <div className="mb-3">
