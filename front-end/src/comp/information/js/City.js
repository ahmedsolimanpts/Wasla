...
function City() {
  ...
  const getCountryData = () => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/country/`, {
        headers: {
  ...
  const handleGetData = (e) => {
    axios
      .get(`${process.env.REACT_APP_HOSTNAME}/api/city-full-data/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const handleEdit = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_HOSTNAME}/api/city/${e.target.id.dataset.id}/`,
        {
      ...
      .catch((error) => {
        if (error.response.status === 400) {
          swal("Error!", "City Already Added!", "error");
        } else {
  ...
  const handleAdd = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_HOSTNAME}/api/city/`,
        {
          city: e.target.city.value,
          country: e.target.country.value,
          language: e.target.language.value,
  ...
  const columns = [
    ...
    {
      name: "Country",
      selector: (row) => row.country.country,
      sortable: true,
      grow: 1,
    },
    {
              ...
              onClick={() => {
                swal({
                  ...
                  if (willDelete) {
                    axios
                      .delete(
                        `${process.env.REACT_APP_HOSTNAME}/api/city/${row.id}/`,
                        {
                          headers: {
                            Authorization: `Bearer ${token}`,
                          },
